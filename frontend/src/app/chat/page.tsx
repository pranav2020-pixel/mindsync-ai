...
export default function ChatPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto h-[calc(100dvh-13.5rem)] lg:h-[calc(100vh-8rem)] flex flex-col">
      <div className="mb-2 sm:mb-4">
        <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-2.5 sm:gap-3"><Brain className="text-wellness-focus" /> AI Wellness Coach</h1>
        <p className="text-muted-foreground text-xs sm:text-sm mt-0.5 sm:mt-1">Talk through your thoughts. I am here to listen and support.</p>
      </div>

      <AnimatePresence>
        {crisisWarning && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="mb-3 sm:mb-4 p-3 sm:p-4 rounded-xl bg-wellness-stress/10 border border-wellness-stress/30 flex items-start gap-3">
            <AlertTriangle className="text-wellness-stress shrink-0" size={20} />
            <div>
              <p className="font-medium text-wellness-stress text-xs sm:text-sm">Crisis Resources</p>
              <p className="text-xs sm:text-sm text-wellness-stress/80 mt-1">
