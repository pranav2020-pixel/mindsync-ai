...
import { Sun, Moon, Bell, LogOut, User, Settings, Check, Trash2, Shield, FileText, Sparkles, Inbox } from "lucide-react";
          ...
          <AnimatePresence>
            {showNotifications && (
              <motion.div
                ...
                className="absolute right-0 top-12 w-80 sm:w-96 glass-card rounded-2xl p-4 shadow-2xl border border-white/10 z-50"
              >
